...
# 使用生产环境配置
cp apps/web-antd/.env.production apps/web-antd/.env.production.bak2
cp apps/web-antd/.env.production.deploy apps/web-antd/.env.production

pnpm build
log_info "编译完成"

# 恢复原配置
mv apps/web-antd/.env.production.bak2 apps/web-antd/.env.production
