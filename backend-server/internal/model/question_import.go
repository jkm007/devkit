...
type QuestionImportTask struct {
	...
	Status           string         `gorm:"type:varchar(30);default:uploaded;index;comment:状态" json:"status"`
...
type QuestionImportItem struct {
	...
	ParseStatus  string    `gorm:"type:varchar(20);not null;comment:解析状态" json:"parseStatus"`
